...
public class PackagedDraconic {
	...
	public static final String VERSION = "1.12.2-1.0.0.6";
	public static final String DEPENDENCIES = "required-after:packagedauto@[1.12.2-1.0.8,);required-after:draconicevolution;";
