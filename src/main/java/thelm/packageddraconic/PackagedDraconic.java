...
public class PackagedDraconic {
	...
	public static final String VERSION = "1.12.2-1.0.0.3";
	public static final String DEPENDENCIES = "required-after:packagedauto@[1.12.2-1.0.7,);required-after:draconicevolution;";
